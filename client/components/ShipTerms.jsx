        ...
        return  (
            <div>
                ...
                <div className="ShipTerms">
                    <h4>Year: <p>This is the year that the Cruise Ship is put into service and ready to take passengers</p></h4> 
                    <h4>Passenger Capacity (Full): <p></p></h4>    
                    <h4>Passenger Capacity (Double Occupancy): <p>This is the maximum amount of passeger that the Cruise Ship can take, based on there being 2 passengers for every cabin that they are staying in.</p></h4>
