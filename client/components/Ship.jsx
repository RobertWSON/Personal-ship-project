  ...
  return (
    <React.Fragment>
      ...
      <div className="ShipDetails">
        ...
        <h4>
          Passenger Capacity (Double Occupsancy):{' '}
          {Double_Occupancy_Passenger_Capacity}
        </h4>
        <h4>Gross Tonnnage: {Gross_Tonnage}</h4>
        <h4>Length: {Length}</h4>
        <h4>Beam: {Beam}</h4>
        <h4>Draft: {Draft}</h4>
        <h4>Height: {Height}</h4>
      ...
      <div className="ShipTermsIntro">
        <p>
          ...
          <br />
          <br />
          If you are interested and want to find out more about what these ship
          terms actually mean, then click{' '}
